...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('logout-pemilik')}}">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{route('data-karyawan-pemilik')}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('rekap-pesanan-pemilik')}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('rekap-gajian')}}">
